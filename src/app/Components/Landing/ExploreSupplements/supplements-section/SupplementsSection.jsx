...
const SupplementsSection = () => {
    ...
    return (
        <div className="px-2 pb-8 md:pb-10 lg:pb-20 xl:pb-30">
            <div className="flex justify-center whitespace-nowrap overflow-x-auto flex-row pb-14 items-center gap-4 custom-sm-range md:pl-0 flow-auto">
                {
                    tabs.map((tab) =>(
                        <button key={tab.key}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 lg:gap-4 gap-2 xl:gap-6">
                {
