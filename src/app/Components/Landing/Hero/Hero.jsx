                ...
                <SwiperSlide>
                    <div className={`bg-[#F6F6F6] lg:pb-28 xl:pb-32 py-2 md:py-8 md:px-0 ${poppins.className}`}>
                        <div className="max-w-7xl mx-auto px-2 flex justify-between flex-col md:flex-row">
                            <div>
                            <h1 className='md:text-3xl text-2xl pt-4 md:pt-12 lg:text-[42px] font-medium xl:text-[55px] pb-8 text-[#2B2B2B] lg:leading-16'>Boost Your Health Naturally with Our Supplement</h1>
