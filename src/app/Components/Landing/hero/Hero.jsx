    ...
    return (
        <div>
            <Swiper
                ...
                <SwiperSlide>
                    <div className={`bg-[#F6F6F6] md:pb-20 lg:pb-28 xl:pb-32 py-2 md:pt-4 lg:pt-4 md:px-0 ${poppins.className}`}>
                        <div className="max-w-7xl mx-auto px-2 flex justify-between flex-col-reverse md:flex-row">
                            <div>
                            <h1 className='md:text-2xl text-2xl pt-4 md:pt-4 xl:pt-8 lg:text-[35px] font-medium xl:text-[55px] pb-4 lg:pb-8 text-primary-color lg:leading-16'>Boost Your Health Naturally with Our Supplement</h1>
                ...
                <SwiperSlide>
                <div className={`bg-[#F6F6F6] md:pb-20 lg:pb-28 xl:pb-32 py-2 md:py-8 md:pt-4 lg:pt-8 md:px-0 ${poppins.className}`}>
                        <div className="max-w-7xl mx-auto px-2 flex justify-between flex-col-reverse md:flex-row">
                            <div>
                            <h1 className='md:text-2xl text-2xl pt-4 md:pt-4 xl:pt-8 lg:text-[35px] font-medium xl:text-[55px] pb-4 lg:pb-8 text-primary-color lg:leading-16'>Boost Your Health Naturally with Our Supplement</h1>
                            <p className='text-secondary-color lg:text-[18px] pb-4 md:pb-8 lg:pb-10 max-w-[760px]'>
                ...
                <SwiperSlide>
                <div className={`bg-[#F6F6F6] md:pb-20 py-2 xl:pb-32 md:py-8 lg:pb-28 md:pt-4 lg:pt-8 md:px-0 ${poppins.className}`}>
                        <div className="max-w-7xl mx-auto px-2 flex justify-between flex-col-reverse md:flex-row">
                            <div>
                            <h1 className='md:text-2xl text-2xl pt-4 md:pt-4 xl:pt-8 lg:text-[35px] font-medium xl:text-[55px] pb-4 lg:pb-8 text-primary-color lg:leading-16'>Boost Your Health Naturally with Our Supplement</h1>
                            <p className='text-secondary-color lg:text-[18px] pb-4 md:pb-8 lg:pb-10 max-w-[760px]'>
