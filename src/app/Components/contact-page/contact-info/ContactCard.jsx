       ...
       <div
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            <div className="bg-cyan-500 p-2 text-white rounded-full w-10 lg:w-15 lg:h-15 xl:h-20 xl:w-20 mb-3 lg:mb-4 xl:mb-5 h-10 flex items-center justify-center text-xl">
              <Image 
                src={info?.image}
                width={45}
                height={45}
          ...
          <p className="text-sm lg:text-lg border-t pt-4 lg:pt-6 xl:pt-9">{info?.contact}</p>
