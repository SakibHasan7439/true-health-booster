...
const statusFuchsia = 'inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-fuchsia-100 text-fuchsia-800 capitalize'; // Example for paid status
...
export const statusClass = {
    ...
    'No': statusDanger,
    'Yes': statusSuccess,
    'Cash On Delivery': statusSuccess,
